...
const DropMenu2 = ({isActive, toggle, xtranslate, ytranslate, width, children}) => {
...
export {DropMenu2, DropMenuElement, DropMenuElementLink, DropMenuHeader, DropMenuElementParams, DropMenuElementText}
