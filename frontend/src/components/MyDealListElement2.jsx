...
const MyDealListElement2 = ({ myDeal, allDirectories, handleChangeDealsList, handleRemoveFromDealList }) => {
    ...
    <div className="deal-list-item">
      ...
      <div className="list-item-second-column">
        ...
        <div className="list-item-diff-section">
            <span>Tournament: {myDeal.deal.tournament ? myDeal.deal.tournament : "-" }</span>
...
export default MyDealListElement2;
